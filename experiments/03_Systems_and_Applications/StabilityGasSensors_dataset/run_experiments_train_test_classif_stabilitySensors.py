...
def train_test(train_size: int = 300, random_state: int = 42):
    ...
    df = pd.read_csv("StabilityGasSensors_dataset.csv", sep=';')
    target = "diff_5_15day_5050"
    representation = "synthesis"
    num_epochs = 120

    config = {
        "property_name": "sensor stability",
    ...
    wandb.init(
        ...
        project="gpt-challenge-classif-stabilitySensors",
        ...
        tags=["classification", "stabilitySensors", "gpt-j-6b"],
    )
