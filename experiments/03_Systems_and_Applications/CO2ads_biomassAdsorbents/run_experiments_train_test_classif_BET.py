...
def train_test(train_size: int = 300, random_state: int = 42):
    ...
    df = pd.read_csv("BET_dataset.csv", sep=';')
    ...
    config = {
        ...
        "tune_settings": {"num_train_epochs": num_epochs, "learning_rate": 5e-4},
    ...
    wandb.init(
        ...
        project="gpt-challenge-classif-bet",
        ...
        tags=["classification", "BET", "gpt-j-6b"],
    )
