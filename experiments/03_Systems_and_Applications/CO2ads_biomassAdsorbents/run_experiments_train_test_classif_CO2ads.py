...
def train_test(train_size: int = 300, random_state: int = 42):
    ...
    df = pd.read_csv("CO2adsorption_dataset.csv", sep=';')
    target = "CO2ads_2bins_5050"
    representation = "adsorption_all_inputs"
    num_epochs = 30

    config = {
        "property_name": "CO2 adsorption capacity (mmol/g)",
    ...
    wandb.init(
        ...
        project="gpt-challenge-classif-co2ads",
        ...
        tags=["classification", "co2ads", "gpt-j-6b"],
    )
