...
def train_test(train_size: int = 300, random_state: int = 42):
    ...
    df = pd.read_csv("GasificationBiomass_dataset.csv", sep=';')
    target = "H2CO_2bins_5050"
    representation = "name_all_prop"
    num_epochs = 30

    config = {
        "property_name": "H2/CO ratio in the syngas obtained from steam gasification",
    ...
    wandb.init(
        ...
        project="gpt-challenge-classif-gasif",
        ...
        tags=["classification", "biomass-gasif", "gpt-j-6b"],
    )
