...
def train_test(train_size: int = 300, random_state: int = 42):
    ...
    df = pd.read_csv("Desalination_dataset.csv", sep=';')
    target = "specificSurface_2bins_5050"
    representation = "effects_T"
    num_epochs = 100

    config = {
        "property_name": "Specific heat transfer surface",
    ...
    wandb.init(
        ...
        project="gpt-challenge-classif-desalination",
        ...
        tags=["classification", "desalination", "gpt-j-6b"],
    )
